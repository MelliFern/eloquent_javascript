...
var getAverage = function(callback1, callback2){
					var array = callback1(callback2);
					var sum = 0;
...
console.log(getAverage(getAgeDiffArray, getMother));

var repeat = funciton(times,callback){
